...
/**
 * The tx_xajax_response class is used to create responses to be sent back to your
...
class tx_xajax_response
{
	 ...
	 * 
	 */
	function tx_xajax_response($sEncoding=XAJAX_DEFAULT_CHAR_ENCODING, $bOutputEntities=false)
	{
...
}// end class tx_xajax_response

if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/xajax/class.tx_xajax_response.php'])	{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/xajax/class.tx_xajax_response.php']);
}
