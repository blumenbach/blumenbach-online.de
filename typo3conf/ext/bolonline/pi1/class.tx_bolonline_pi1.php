...
//		include_once("./bolonline.main.conf.php");
        ...
        $xajax->registerExternalFunction('setImageOrder', t3lib_extMgm :: siteRelPath('bolonline') . '/pi1/ImageOrder.ajax.incl.php');
...
//        if(time()%2==0) die();
        ...
        if ($_SESSION['todo'] == 'update') {
          ...
          $content .= '<script type="text/javascript" src="' . t3lib_extMgm :: siteRelPath('bolonline') . '/pi1/bolobjectFilter.js"></script>
            ...
            // the object select menu
            $content .= '<tr><td colspan="2"><form name="update" action="' . $this->pi_getPageLink($GLOBALS['TSFE']->id) . '" method="POST">';
