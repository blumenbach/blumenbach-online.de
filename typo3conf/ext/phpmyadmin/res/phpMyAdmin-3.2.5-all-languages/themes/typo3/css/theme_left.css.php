 ...
 *
 * @version $Id: theme_left.css.php 30792 2010-03-05 22:55:26Z mehrwert $
...
div#left_tableList p a.item .navi_dbName,
div#left_tableList p,
div#left_tableList p a:hover,
div#left_tableList p a.item:hover .navi_dbName {
	font-weight:        bold;
    color:              #000;
    background:         #B8BEC9 url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>bg_group.gif) repeat-x;
    padding: 2px;
}
